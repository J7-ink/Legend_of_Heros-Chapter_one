...
class AnimationPlayer:
    def __init__(self):
        # import all the particle affects using a dictionary
        self.frames = {
            # magic/special attacks
            'flame': import_folder('../particles/flame/frames'),
            'aura': import_folder('../particles/aura'),
            'minor_heal': import_folder('../particles/heal/frames'),
            ...
            'mino': import_folder('../particles/nova'),
    ...
    def reflect_images(self, frames):
        """this function reflects the images it is displaying for more variation"""
        new_frames = []
